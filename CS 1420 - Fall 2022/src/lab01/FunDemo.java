...
public class FunDemo extends JPanel
{
    ...
    final static public String greeting = "Welcome to Computer Science";
...
System.out.println("Consider city populations.  The most significant digit in "
		+ "city populations is six times more likely to be a 1 than a 9.  (See Benfords "
		+ "law.)");
